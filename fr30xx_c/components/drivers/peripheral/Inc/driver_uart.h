...
/* uart_transmit */
/* uart_receive */
void uart_transmit(UART_HandleTypeDef *huart, const uint8_t *fp_Data, uint32_t fu32_Size);
void uart_receive(UART_HandleTypeDef *huart, uint8_t *fp_Data, uint32_t fu32_Size);

/* uart_transmit_IT */
/* uart_receive_IT */
void uart_transmit_IT(UART_HandleTypeDef *huart, const uint8_t *fp_Data, uint32_t fu32_Size);
