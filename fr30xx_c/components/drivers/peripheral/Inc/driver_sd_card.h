...
/* card Physical Layer Specification Version */
#define CARD_PHY_LAYER_SPEC_VERSION_UNKNOWN    (0U)        /*!< unknown */
#define CARD_PHY_LAYER_SPEC_VERSION_V101       (1U)        /*!< Version 1.01 */
#define CARD_PHY_LAYER_SPEC_VERSION_V110       (3U)        /*!< Version 1.10 */
#define CARD_PHY_LAYER_SPEC_VERSION_V200       (4U)        /*!< Version 2.00 */
#define CARD_PHY_LAYER_SPEC_VERSION_V30x       (5U)        /*!< Version 3.0x */
...
typedef struct
{
    ...
    uint32_t SpecVersion;                  /*!< Specifies the card Physical Layer Specification Version */
}SD_CardInfoTypeDef;
...
typedef struct
{
    ...
    SD_CardSCRTypeDef     *SCRInfo;          /*!< SCR information    */
