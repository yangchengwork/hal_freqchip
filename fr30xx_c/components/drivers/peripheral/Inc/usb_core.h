...
/*
   ...
   usb_dev              1.0.0            2024/1/9         First edition
                        1.0.1            2024/11/7        get device/endpoint status use macro definition.
                        1.0.2            2024/12/19       1.optimize DESCRIPTOR_STRING processing.
                                                          2.optimize REQUEST_SET_ADDRESS processing.
   ------------------------------------------------------------------------------------------------------- 
   ...
   usb_hid              1.0.0            2024/1/9         First edition
                        1.0.1            2024/12/19       optimize HID_GET_PROTOCOL/HID_SET_PROTOCOL processing.
   -------------------------------------------------------------------------------------------------------
